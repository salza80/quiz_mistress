...
ActiveRecord::Schema.define(version: 2018_08_20_001003) do
  ...
  create_table "outcomes", id: :serial, force: :cascade do |t|
    ...
    t.index ["quiz_id"], name: "index_outcomes_on_quiz_id"
  end
  ...
  create_table "quizzes", id: :serial, force: :cascade do |t|
    ...
    t.integer "user_id"
    t.index ["url_name"], name: "index_quizzes_on_url_name", unique: true
